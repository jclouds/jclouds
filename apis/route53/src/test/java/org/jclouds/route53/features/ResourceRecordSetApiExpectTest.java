...
public class ResourceRecordSetApiExpectTest extends BaseRoute53ApiExpectTest {
   ...
   public void testListWhenResponseIs404() {
      ...
      assertEquals(fail.getResourceRecordSetApiForHostedZone("Z1PA6795UKMFR9").list().get(0).toImmutableSet(), ImmutableSet.of());
   }
   ...
   public void testList2PagesWhenResponseIs2xx() {
      ...
      assertEquals(success.getResourceRecordSetApiForHostedZone("Z1PA6795UKMFR9").list().concat().toImmutableSet(), new ListResourceRecordSetsResponseTest().expected()
            .toImmutableSet());
   }
